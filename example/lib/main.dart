    ...
    return MessageTileCard(
      child: LayoutBuilder(
        builder: (context, constraints) => Prerender(
          target: PrerenderedMessageTile(message: message),
...
class PrerenderedMessageTile extends StatelessWidget {
  const PrerenderedMessageTile({super.key, required this.message});
